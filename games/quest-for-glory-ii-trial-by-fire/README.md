...
**Sierra On-Line, 1990.** Quest for Glory II: Trial by Fire is the second video
game in Sierra On-Line's Quest for Glory series, and the sequel to Hero's
Quest: So You Want to Be a Hero.
...
| **Programmer** | Robert Fischbach                  |
| **Artist**     | Kenn Nishiuye                     |
| **Composer**   | Christopher Braymen, Mark Seibert |
...
`docs/released-games.md` lists this title under **Sierra SCI01 — not supported
...
- [Wikipedia: Quest for Glory II: Trial by Fire](https://en.wikipedia.org/wiki/Quest_for_Glory_II:_Trial_by_Fire)
